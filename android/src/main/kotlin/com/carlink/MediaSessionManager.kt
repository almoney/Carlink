...
class MediaSessionManager(
    ...
    // Callback for routing media button events back to Flutter/adapter
    ...
    fun initialize() {
        ...
        try {
            mediaSession = MediaSessionCompat(context, "CarlinkMediaSession").apply {
     ...
     */
    private fun buildPlaybackState(state: Int, position: Long = 0L): PlaybackStateCompat {
