...
class MicrophoneCaptureManager(
    ...
    fun start(decodeType: Int = 5): Boolean {
        synchronized(lock) {
            ...
            try {
                ...
                log("[MIC] Capture started: ${format.sampleRate}Hz ${format.channelCount}ch buffer=${recordBufferSize}B")
                return true
    ...
    fun availableBytes(): Int {
        return micBuffer?.availableForRead() ?: 0
    }
    ...
    fun bufferLevelMs(): Int {
        return micBuffer?.fillLevelMs() ?: 0
    }
